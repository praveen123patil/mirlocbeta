        ...
        <div class="col-lg-12">
           ...
           <div class="panel panel-info">
                <div class="panel-heading">
                     <i class="fa fa-plus"></i> &nbsp;<?php echo $floor_plan['image_title']; ?><a href="<?php echo site_url('admin/floorplan/delete/'.$floor_plan['id']); ?>" class="btn btn-info btn-sm pull-right"><i class="fa fa-trash-o"></i> Delete Image </a>
            ...
            <?php endif ?>
                  ...
                  <form method="post" action="<?php echo base_url('admin/floorplan/create') ?>" class="form-horizontal" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-12">
                        <input type="text" name='image_title' class="form-control" value='<?php echo $floor_plan['image_title']; ?>'/>
                      </div>
                    </div>
