  ...
  <div class="col-lg-12">
    ...
    <div class="panel panel-info">
      <div class="panel-heading">
        <i class="fa fa-plus"></i> &nbsp;Add New Home Banners<a href="<?php echo site_url('admin/propertybanner/index/'); ?>" class="btn btn-info btn-sm pull-right"><i class="fa fa-list"></i> Banner List </a>
